...
class ProteinStructureOperator:
    ...
    @staticmethod
    def crossover_single(parent1: ProteinStructureSolution,
    ...
    def crossover_multipoint(parent1: ProteinStructureSolution,
        ...
        return ProteinStructureCreator.create_structure(parent1.seq_HP, seq1_directions, parent1, parent2), \
               ProteinStructureCreator.create_structure(parent2.seq_HP, seq2_directions, parent1, parent2)
    ...
    def mutation_segment(parent: ProteinStructureSolution) -> ProteinStructureSolution:
        ...
        return ProteinStructureCreator.create_structure(parent.seq_HP, seq_directions, parent)
    ...
    def mutation_exhaustive_search(parent: ProteinStructureSolution) -> ProteinStructureSolution:
        ...
        for direction in range(len(get_directions_12())):
            if direction != parent.structure_directions[mutation_pos]:
                ...
                cur_solution = ProteinStructureCreator.create_structure(parent.seq_HP, seq_dir, parent)
    ...
    def mutation_local_move(parent: ProteinStructureSolution) -> ProteinStructureSolution:
        ...
        return ProteinStructureCreator.create_structure(parent.seq_HP, seq_dir, parent)
