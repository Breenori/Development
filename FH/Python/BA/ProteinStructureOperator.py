...
class ProteinStructureOperator:
    ...
    @staticmethod
    def crossover_single(parent1: ProteinStructureSolution, parent2: ProteinStructureSolution) -> (ProteinStructureSolution,ProteinStructureSolution):
        return ProteinStructureOperator.crossover_multipoint(parent1, parent2, 1)

    @staticmethod
    def crossover_multipoint(parent1: ProteinStructureSolution, parent2: ProteinStructureSolution, n: int) -> (ProteinStructureSolution, ProteinStructureSolution):
        points = []
    ...
    def mutation_segment(parent: ProteinStructureSolution) -> ProteinStructureSolution:
        ...
        for i in range(pos, pos + num_mutations):
            seq_directions[i] = rng.randint(0, len(directions)-1)
