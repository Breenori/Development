...
bool test_parenthesis() {
    ...
    helper_tester(expressions[0], "27");
...
bool test_custom() {
    ...
    std::vector const expressions{
       "11 / (-17.3 * 22 + 3)"s,    // / - Double in Parenthesis
       "62 / (-17 * 2 + 3)"s,       // All Integers; / - Integer in Parenthesis
       "((17 * -4) + 8) / -6"s,     // Division Minus. Nested parenthesis
       "1 + 2.0 + 3 * (-5 + -4)"s   // * Minus Double
    };
